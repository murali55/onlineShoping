...
public class DBConfiguration 
{
   ...
   public SessionFactory sessionFactory()
   {
		...
		lsf.scanPackages("com.first.entites"); //scan all entities in the package com.niit.models and map it with relational tables
		System.out.println("sessionFactory bean is created");
	    return lsf.buildSessionFactory();   //classes is an array of class objects of entities..
   }
